...
```sh
sh <(curl -L https://github.com/input-output-hk/nix-unstable-installer/releases/download/nix-2.5pre20211008_6bd74a6/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v11
      with:
        install_url: https://github.com/input-output-hk/nix-unstable-installer/releases/download/nix-2.5pre20211008_6bd74a6/install
